...
def obtener_recepciones():
    """Obtener todas las recepciones históricas desde Supabase"""
    if request.method == 'OPTIONS':
        return '', 200
...
def guardar_recepcion():
    """Guardar una nueva recepción en el historial"""
    if request.method == 'OPTIONS':
        return '', 200
...
def eliminar_recepcion():
    """Eliminar una recepción del historial"""
    if request.method == 'OPTIONS':
        return '', 200
